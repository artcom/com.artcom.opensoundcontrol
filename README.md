...
<root>
  ...
  ├── Editor
  │   ├── Martinzier.OpenSoundControl.Editor.asmdef
  │   └── EditorExample.cs
  ├── Runtime
  │   ├── Martinzier.OpenSoundControl.asmdef
  │   └── RuntimeExample.cs
  ├── Tests
  │   ├── .tests.json
  │   ├── Editor
  │   │   ├── Martinzier.OpenSoundControl.Editor.Tests.asmdef
  │   │   └── EditorExampleTest.cs
  │   └── Runtime
  │        ├── Martinzier.OpenSoundControl.Tests.asmdef
...
1. Enter your package name. The name you choose should contain your default organization followed by the name you typed. For example: `Martinzier.OpenSoundControl`.
...
To use the Inspector, select the `package.json` file in the Project browser. The **Package Open Sound Control Manifest** page opens for editing.
...
* Store Editor-specific code under a root editor assembly definition file:
  ...
  `Editor/Martinzier.OpenSoundControl.Editor.asmdef`

* Store runtime-specific code under a root runtime assembly definition file:

  `Runtime/Martinzier.OpenSoundControl.asmdef`

* Configure related test assemblies for your editor and runtime scripts:

  `Tests/Editor/Martinzier.OpenSoundControl.Editor.Tests.asmdef`

  `Tests/Runtime/Martinzier.OpenSoundControl.Tests.asmdef`
...
Use the `Documentations~/Open Sound Control.md` documentation file to create preliminary, high-level documentation. This document should introduce users to the features and sample files included in your package.  Your package documentation files will be used to generate online and local docs, available from the Package Manager UI.
